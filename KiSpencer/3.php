...
echo "<h3 class='text-center text-primary'>--Products In ".$row[0]."--</h3>";

$qry = "Select product_name, price, quantity, product_id from product where category_id = 3 ";
$res = mysql_query($qry);
...
$flag = 1;
	...
	while($row = mysql_fetch_array($res))
	{
		...
		for($k = 1; $k <= $count; $k++)
		{ 
			echo "<div class='' style='padding:10px; box-shadow:0px 0px 5px solid grey;'>";
